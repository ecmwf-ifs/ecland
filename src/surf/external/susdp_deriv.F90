SUBROUTINE SUSDP_DERIV    (YSURF, KIDIA, KFDIA, PSLT, PSSDP2, PSSDP3, KLEVS3D)
...
CALL SUSDP_DERIV_CTL   (KIDIA, KFDIA, PSLT, KLEVS3D, PSSDP2, PSSDP3, YSURF%YVEG, YSURF%YSOIL, YSURF%YAGS, YSURF%YCST)  
