...
USE YOS_SURF, ONLY : TSURF, ALLO_SURF, GET_SURF, ALLO_SURF_NO_TLIST
...
IF (PRESENT(PRCIMIN)) THEN
  CALL SUSURF_CTL(KSW,KCSS,KCSNEC,KSIL,KCOM,KTILES,KTSW,KLWEMISS,&
   ...
   & PRLAIINT,PRSUN,PRCORIOI,PRPLRG, PNSNMLWS,&
   & PRVR0VT,PRVCMAX25,PRHUMREL,PRA1,PRB1,PRG0,PRGM25,PRE_VCMAX,PRE_JMAX,& 
   & YSURF_LOC%YDIM,YSURF_LOC%YEXC,YSURF_LOC%YCST,YSURF_LOC%YRAD,YSURF_LOC%YRDI,YSURF_LOC%YLW,&
   & YSURF_LOC%YSW,YSURF_LOC%YSOIL,YSURF_LOC%YVEG,YSURF_LOC%YAGS,YSURF_LOC%YAGF,YSURF_LOC%YMLM,YSURF_LOC%YFLAKE,&
   & YSURF_LOC%YOCEAN_ML,YSURF_LOC%YURB,PRALFMINPSN, PRCIMIN=PRCIMIN )
...
ELSE
  CALL SUSURF_CTL(KSW,KCSS,KCSNEC,KSIL,KCOM,KTILES,KTSW,KLWEMISS,&
   ...
   & YSURF_LOC%YDIM,YSURF_LOC%YEXC,YSURF_LOC%YCST,YSURF_LOC%YRAD,YSURF_LOC%YRDI,YSURF_LOC%YLW,&
   & YSURF_LOC%YSW,YSURF_LOC%YSOIL,YSURF_LOC%YVEG,YSURF_LOC%YAGS,YSURF_LOC%YAGF,YSURF_LOC%YMLM,YSURF_LOC%YFLAKE,&
   & YSURF_LOC%YOCEAN_ML,YSURF_LOC%YURB,PRALFMINPSN)
