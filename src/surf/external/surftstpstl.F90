...
IF(UBOUND(KSOTY,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF KSOTY TOO SHORT!')
ENDIF
...
CALL SURFTSTPSTL_CTL(KIDIA , KFDIA , KLON  , KLEVS , KLEVSN, & 
 & KTILES, KSOTY,&
 & PTSPHY , PFRTI,&
!-trajectory
 & LDLAND  , LDSICE  , LDSI     , LDNH   , LDREGSF,&
 ...
 & PSLRFL5 ,PSSFC5    , PSSFL5   ,&
 & PCVL    ,PCVH      , PWLMX5   , PEVAPSNW5, &
 & YSURF%YCST,YSURF%YVEG,YSURF%YSOIL,YSURF%YFLAKE,&
!-TENDENCIES OUTPUT
 & PTSNE15 , PTSAE15  , PTIAE15  ,&
!-perturbations
 & PAHFSTI , PEVAPTI  , PSSRFLTI ,&
