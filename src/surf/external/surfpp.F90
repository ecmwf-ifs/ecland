...
IF(UBOUND(PZ0MTIW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP:: FIRST DIMENSION OF PZ0MTIW TOO SHORT!')
ENDIF
IF(UBOUND(PZ0MTIW,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPP:: SECOND DIMENSION OF PZ0MTIW TOO SHORT!')
ENDIF
IF(UBOUND(PZ0HTIW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP:: FIRST DIMENSION OF PZ0HTIW TOO SHORT!')
ENDIF
IF(UBOUND(PZ0HTIW,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPP:: SECOND DIMENSION OF PZ0HTIW TOO SHORT!')
ENDIF
IF(UBOUND(PZ0HTIW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP:: FIRST DIMENSION OF PZ0HTIW TOO SHORT!')
ENDIF
...
IF(UBOUND(PZ0QTIW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP:: FIRST DIMENSION OF PZ0QTIW TOO SHORT!')
ENDIF
IF(UBOUND(PZ0QTIW,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPP:: SECOND DIMENSION OF PZ0QTIW TOO SHORT!')
ENDIF
IF(UBOUND(PZDLTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP:: FIRST DIMENSION OF PZDLTI TOO SHORT!')
ENDIF
IF(UBOUND(PZDLTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPP:: SECOND DIMENSION OF PZDLTI TOO SHORT!')
ENDIF
IF(UBOUND(PQSAPPTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP:: FIRST DIMENSION OF PQSAPPTI TOO SHORT!')
ENDIF
IF(UBOUND(PQSAPPTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPP:: SECOND DIMENSION OF PQSAPPTI TOO SHORT!')
ENDIF
IF(UBOUND(PCPTSPPTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP:: FIRST DIMENSION OF PCPTSPPTI TOO SHORT!')
ENDIF
IF(UBOUND(PCPTSPPTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPP:: SECOND DIMENSION OF PCPTSPPTI TOO SHORT!')
ENDIF
...
IF(UBOUND(PUSTOKES,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP: PUSTOKES TOO SHORT!')
ENDIF

IF(UBOUND(PVSTOKES,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP: PVSTOKES TOO SHORT!')
ENDIF
...
IF(UBOUND(P10NU,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP: P10NU TOO SHORT!')
ENDIF

IF(UBOUND(P10NV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP: P10NV TOO SHORT!')
ENDIF

IF(UBOUND(PUST,1) < KLON) THEN
  CALL ABORT_SURF('SURFPP: PUST TOO SHORT!')
ENDIF
