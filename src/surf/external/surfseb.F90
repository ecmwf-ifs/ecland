...
IF(UBOUND(PLAMSK,1) < KLON) THEN
  CALL ABORT_SURF('SURFSEB:: FIRST DIMENSION OF PLAMSK TOO SHORT!')
ENDIF

IF(UBOUND(PLAMSK,2) < KTILES) THEN
  CALL ABORT_SURF('SURFSEB:: SECOND DIMENSION OF PLAMSK TOO SHORT!')
ENDIF
...
IF(UBOUND(PSNM,1) < KLON) THEN
  CALL ABORT_SURF('SURFSEB:: FIRST DIMENSION OF PSNM TOO SHORT!')
ENDIF

IF(UBOUND(PRSN,1) < KLON) THEN
  CALL ABORT_SURF('SURFSEB:: FIRST DIMENSION OF PRSN TOO SHORT!')
ENDIF
