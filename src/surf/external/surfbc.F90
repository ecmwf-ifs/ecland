...
IF(UBOUND(PAVGPARC,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PAVGPARC TOO SHORT!')
ENDIF

IF(UBOUND(PLAILCP,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PLAILCP TOO SHORT!')
ENDIF

IF(UBOUND(PLAIHCP,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PLAIHCP TOO SHORT!')
ENDIF
...
IF(UBOUND(PCIL,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PCIL TOO SHORT!')
ENDIF
...
IF(UBOUND(LDLICE,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: LDLICE TOO SHORT!')
ENDIF
...
IF(UBOUND(PLAILP,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PLAILP TOO SHORT!')
ENDIF

IF(UBOUND(PLAIHP,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PLAIHP TOO SHORT!')
ENDIF

IF(UBOUND(PAVGPAR,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PAVGPAR TOO SHORT!')
ENDIF
...
IF(UBOUND(PCSN,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PCSN TOO SHORT!')
ENDIF
