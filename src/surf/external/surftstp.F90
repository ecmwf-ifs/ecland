...
INTEGER(KIND=JPIM),INTENT(IN)    :: NSSDP2D
INTEGER(KIND=JPIM),INTENT(IN)    :: NSSDP3D
INTEGER(KIND=JPIM),INTENT(IN)    :: NCSS
...
REAL(KIND=JPRB)   ,INTENT(IN)    :: PSSDP3(KLON,NCSS,NSSDP3D)
