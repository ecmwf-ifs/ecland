...
CALL SURFSEBS_CTL      (KIDIA,KFDIA,KLON,KTILES,LDSICE,KTVL,KTVH,&
 & PTMST,LLREPEAT,PSSKM1M,PTSKM1M,PQSKM1M,PDQSDT,PRHOCHU,PRHOCQU,&
 & PALPHAL,PALPHAS,PSSRFL,PFRTI,PTSRF,&
 & PSNS,PRSN,PHLICE, & 
 & PSLRFL,PTSKRAD,PEMIS,PASL,PBSL,PAQL,PBQL,&
 & PTHKICE,PSNTICE,&
 & YSURF%YCST,YSURF%YEXC,YSURF%YVEG,YSURF%YFLAKE,YSURF%YURB,YSURF%YSOIL,&
 & PJS,PJQ,PSSK,PTSK,PSSH,PSLH,PSTR,PG0,&
 & PSL,PQL,&
 & LNEMOLIMTHK)  
