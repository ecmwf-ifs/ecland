...
LOGICAL         ::    LNEMOLIMTHK,LREPEAT,LSICOUP
...
CALL SURFSEB   (YSURF=YSURF,KIDIA=KIDIA,KFDIA=KFDIA,KLON=KLON,KTILES=KTILES,KTVL=KTVL,KTVH=KTVH,&
 & PTMST=PTMST,PSSKM1M=PCPTSTIU,PTSKM1M=PTSKTI,PQSKM1M=PQSTI,&
...
CALL SURFSEB   (YSURF=YSURF,KIDIA=KIDIA,KFDIA=KFDIA,KLON=KLON,KTILES=KTILES,KTVL=KTVL,KTVH=KTVH,&
 & PTMST=PTMST,PSSKM1M=ZPCPTSTIU,PTSKM1M=PTSKTI,PQSKM1M=PQSTI,&
 & PDQSDT=PDQSTI,PRHOCHU=ZRHOCHU,PRHOCQU=ZRHOCQU,&
...
CALL SURFSEB   (YSURF=YSURF,KIDIA=KIDIA,KFDIA=KFDIA,KLON=KLON,KTILES=KTILES,KTVL=KTVL,KTVH=KTVH,&
 & PTMST=PTMST,PSSKM1M=PCPTSTI,PTSKM1M=PTSKTI,PQSKM1M=PQSTI,&
 & PDQSDT=PDQSTI,PRHOCHU=ZRHOCHU,PRHOCQU=ZRHOCQU,&
