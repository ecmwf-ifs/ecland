...
D1SRADTK(KIDIAF:KFDIAF) = 0._JPRB ! not calculated in vdfmain
...
D1SVEGEV(KIDIAF:KFDIAF) = 0._JPRB ! not used
D1SDSH(KIDIAF:KFDIAF) = 0._JPRB ! DelSoilHeat of skin layer (0)
