...
D1SWARS(KIDIAF:KFDIAF,:,IBL) = 0. ! excess runoff
...
D1SWAC(KIDIAF:KFDIAF,:,IBL) = 0. ! clipping
...
D1SRADTK(KIDIAF:KFDIAF,IBL) = 0. ! not calculated in vdfmain
...
D1SVEGEV(KIDIAF:KFDIAF,IBL) = 0.! not used
D1SDSH(KIDIAF:KFDIAF,IBL) = 0.! DelSoilHeat of skin layer (0)
