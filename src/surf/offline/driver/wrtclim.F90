...
LOGICAL LPOS
INTEGER(KIND=JPIM) :: IX1,IX2,IY1,IY2,NLEN,IST,IEN,JK,JL,JS,ISTP,IENP,IBL,IL,IEND,IPROMA
...
!******************************************************************
  IF (LEVGEN) THEN
    ...
    CALL SURF_INQ(YSURF,PRVCOV=ZRVCOV,PRDAW=RDAW,PRWSATM=RWSATM,PRWCAPM=RWCAPM,PRWPWPM=RWPWPM,&
                  PRVROOTSA=ZRVROOTSA)

  ELSE
    CALL SURF_INQ(YSURF,PRVCOV=ZRVCOV,PRDAW=RDAW,PRWSAT=RWSAT,PRWCAP=RWCAP,PRWPWP=RWPWP,&
                  PRVROOTSA=ZRVROOTSA)
  ENDIF
