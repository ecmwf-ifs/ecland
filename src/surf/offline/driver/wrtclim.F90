...
!     --------------
!        original: 14/7/2000
!        I. Ayan-Miguez June 2023 Change RVCOV to spatially distributed parameter
...
USE YOMGPD1S , ONLY : VFSOTY,VFCVL    ,VFCVH    ,VFTVL    ,VFTVH, VFCO2TYP, S2RVCOVH2D, S2RVCOVL2D
USE MPL_MODULE
IMPLICIT NONE
...
!* Local variables
REAL(KIND=JPRB),ALLOCATABLE :: ZVALUE(:),ZRVROOTSA(:,:), ZBUF(:)
...
!******************************************************************
  IF (LEVGEN) THEN
    ...
    CALL SURF_INQ(YDSURF,PRDAW=RDAW,PRWSATM=RWSATM,PRWCAPM=RWCAPM,PRWPWPM=RWPWPM,&
                  PRVROOTSA=ZRVROOTSA)
