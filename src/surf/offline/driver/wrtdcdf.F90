...
USE YOMGPD1S , ONLY : VFCVL    ,VFCVH    ,VFTVL    ,VFTVH    ,VFSOTY   ,&
           &VFOCDEPTH,VFZO     ,VDZ0F    ,VDZ0H    , VFCLAKEF
...
REAL(KIND=JPRB) :: ZWA,ZMM,ZMM2,ZPA,ZWPWP,ZWSAT,ZCVL,ZCVH,ZBOT,ZF,&
     &  ZTOP,ZRVCOV(0:20),ZRVROOTSA(NCSS,0:20),RLMLT,ZIHCAP,ZEPSILON
REAL(KIND=JPRD) :: ZJUL
...
IF (LEVGEN) THEN
  ...
  CALL SURF_INQ(YDSURF,PRVCOV=ZRVCOV,PRVROOTSA=ZRVROOTSA,&
              &PRDAW=RDAW,PRWSATM=RWSATM,PRWPWPM=RWPWPM)
ELSE
  CALL SURF_INQ(YDSURF,PRVCOV=ZRVCOV,PRVROOTSA=ZRVROOTSA,&
              &PRDAW=RDAW,PRWSAT=RWSAT,PRWPWP=RWPWP)
ENDIF
...
ZSNOFR(1:NPOI)=D1SNFR2(1:NPOI,IA)*ZWA
ZICEFR(1:NPOI)=D1STIFR2(1:NPOI,2,IA)*ZWA
