...
USE YOMDPHY  , ONLY : NCSS     ,NTILES , YDSURF , NCSNEC, YSURF
...
CALL SUSURF(KSW=NSW,KCSS=NCSS,KCWS=NCWS,KCSNEC=NCSNEC,KSIL=NSIL,KCOM=NCOM,KTILES=NTILES,KTSW=NTSW,KLWEMISS=NLWEMISS,&
    ...
    & YDSURF=YDSURF,YSURF=YSURF,PRALFMINPSN=RALFMINPSN,PRCIMIN=RCIMIN, TMP_SURF=TMP_SURF) 
...
LEWBCHECK=YSURF_LOC%YSOIL%LEWBCHECK
LEWBCHECKAbort=YSURF_LOC%YSOIL%LEWBCHECKAbort
LESNCHECK=YSURF_LOC%YSOIL%LESNCHECK
LESNCHECKAbort=YSURF_LOC%YSOIL%LESNCHECKAbort
LESKTI5=YSURF_LOC%YSOIL%LESKTI5
LESKTI8=YSURF_LOC%YSOIL%LESKTI8
LESOILCOND=YSURF_LOC%YSOIL%LESOILCOND
LEWBSOILFIX=YSURF_LOC%YSOIL%LEWBSOILFIX
LESNWBCON=YSURF_LOC%YSOIL%LESNWBCON
...
! update buffer 
YSURF_LOC%YSOIL%LEWBCHECK=LEWBCHECK
YSURF_LOC%YSOIL%LEWBCHECKAbort=LEWBCHECKAbort
YSURF_LOC%YSOIL%LESNCHECK=LESNCHECK
YSURF_LOC%YSOIL%LESNCHECKAbort=LESNCHECKAbort
YSURF_LOC%YSOIL%LESKTI5=LESKTI5
YSURF_LOC%YSOIL%LESKTI8=LESKTI8
YSURF_LOC%YSOIL%LEWBSOILFIX=LEWBSOILFIX
YSURF_LOC%YSOIL%LESOILCOND=LESOILCOND
YSURF_LOC%YSOIL%LESNWBCON=LESNWBCON
YSURF_LOC%YSOIL%LEROLAKE=LEROLAKE
...
DO I=1,NCSS
  YSURF_LOC%YSOIL%RDAT(I) = RDAW(I)
  YSURF_LOC%YSOIL%RDAW(I) = RDAW(I)
  YSURF_LOC%YSOIL%RDAI(I) = RDAW(I)
...
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LEWBCHECK  = '',L5)') YSURF_LOC%YSOIL%LEWBCHECK
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LEWBCHECKAbort  = '',L5)') YSURF_LOC%YSOIL%LEWBCHECKAbort
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LESNCHECK  = '',L5)') YSURF_LOC%YSOIL%LESNCHECK
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LESNCHECKAbort  = '',L5)') YSURF_LOC%YSOIL%LESNCHECKAbort
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LESKTI5  = '',L5)') YSURF_LOC%YSOIL%LESKTI5
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LESKTI8  = '',L5)') YSURF_LOC%YSOIL%LESKTI8
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LEWBSOILFIX  = '',L5)') YSURF_LOC%YSOIL%LEWBSOILFIX
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LESOILCOND  = '',L5)') YSURF_LOC%YSOIL%LESOILCOND
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LESNWBCON  = '',L5)') YSURF_LOC%YSOIL%LESNWBCON
WRITE(UNIT=KULOUT,FMT='('' YSURF%YSOIL%LEROLAKE  = '',L5)') YSURF_LOC%YSOIL%LEROLAKE
