...
! - INPUT .
     ...
     & , VFCVL(1:IPROMA,IBL)  , VFCVH(1:IPROMA,IBL)  , VFCUR(1:IPROMA,IBL) , VFTVL(1:IPROMA,IBL)  , VFCO2TYP(1:IPROMA,IBL), VFISOP_EP(1:IPROMA,IBL), VFTVH(1:IPROMA,IBL)  &
     & , VFLAIL(1:IPROMA,IBL) , VFLAIH(1:IPROMA,IBL) , VFFWET(1:IPROMA,IBL) , VFAVGPAR(1:IPROMA,IBL), VFRSML(1:IPROMA,IBL) , VFRSMH(1:IPROMA,IBL) &
