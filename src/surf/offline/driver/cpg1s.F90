...
! - OUTPUT .
     ...
     & , ZDHCO2S(1:IPROMA,:,:,IBL),ZDHBVOCS(1:IPROMA,:,:,IBL),ZDHBIOS(1:IPROMA,:,:,IBL),ZDHVEGS(1:IPROMA,:,:,IBL))
...
!     ------------------------------------------------------------------
  ...
  CALL UPDDIAG( &
   ...
   & ZEVAPTIU(1:IPROMA,:,IBL),&
   & ZAN(1:IPROMA,IBL),ZAG(1:IPROMA,IBL),ZRD(1:IPROMA,IBL),ZRSOIL_STR(1:IPROMA,IBL),ZRECO(1:IPROMA,IBL),ZCO2FLUX(1:IPROMA,IBL),ZCH4FLUX(1:IPROMA,IBL), ZBVOCFLUX(1:IPROMA,:,IBL), &
