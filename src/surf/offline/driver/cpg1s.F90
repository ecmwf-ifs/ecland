...
CHARACTER*1 :: CDCONF 
REAL(KIND=JPRB) ::  ZAPRS(NPOI,0:NLEV),ZAPHIF(NPOI,NLEV)
...
!     STAFF FOR CALLPAR1S
  ...
  ZAPRS(IST:IEND,IFLEV-1)=PNLP0(IST:IEND)-RALT*0.0065_JPRB
...
! - INPUT .
     ...
     & , TILNU0(IST:IEND,:) &
     & , TLICENU0(IST:IEND),TLMNWNU0(IST:IEND),TLWMLNU0(IST:IEND),TLBOTNU0(IST:IEND),TLSFNU0(IST:IEND) &
     ! FLAKE
     ...
     & , VFCI(IST:IEND)   , VFCIL(IST:IEND), VFSST(IST:IEND)   , GEMU(IST:IEND),  GELAT(IST:IEND), ZCFLX(IST:IEND,:) &
