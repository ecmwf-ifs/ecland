...
UNLEV0(:,NLEV)=ZW*UFI(:,IF)+ZWP1*UFI(:,IFP1)
VNLEV0(:,NLEV)=ZW*VFI(:,IF)+ZWP1*VFI(:,IFP1)
TNLEV0(:,NLEV)=ZW*TFI(:,IF)+ZWP1*TFI(:,IFP1)
QNLEV0(:,NLEV)=ZW*QFI(:,IF)+ZWP1*QFI(:,IFP1)
...
UNLEV1(:,NLEV)=ZWP*UFI(:,IFP)+ZWPP1*UFI(:,IFPP1)
VNLEV1(:,NLEV)=ZWP*VFI(:,IFP)+ZWPP1*VFI(:,IFPP1)
TNLEV1(:,NLEV)=ZWP*TFI(:,IFP)+ZWPP1*TFI(:,IFPP1)
QNLEV1(:,NLEV)=ZWP*QFI(:,IFP)+ZWPP1*QFI(:,IFPP1)
