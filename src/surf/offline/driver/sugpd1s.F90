...
USE YOMGPD1S , ONLY : GPD, GPD_SDP2, GPD_SDP3       ,&
            ...
            &VFPGLOB, S2RVCOVH2D, S2RVCOVL2D, S2RVLAMSKH2D, S2RVLAMSKL2D,&
            &S2RVLAMSKSH2D, S2RVLAMSKSL2D, S2RVRSMINH2D, S2RVRSMINL2D,&
            &S2RVZ0HH2D, S2RVZ0HL2D, &
            &S2RVANMAXL2D, S2RVZ0MH2D, S2RVZ0ML2D, S2RVRSMINB2D,&
            &S3RMVGALPHA3D
...
ALLOCATE (GPD_SDP2(NPOI,13))  ! TODO: Change 13 by a global param in ifsaux 
...
S2RVANMAXL2D => GPD_SDP2(:,SSDP2D_ID%NRVANMAXL2D) !derived SDP
...
ALLOCATE (GPD_SDP3(NPOI,NCSS,1))  ! TODO: Change 1 by a global param in ifsaux 
