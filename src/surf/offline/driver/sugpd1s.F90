...
USE YOMGPD1S , ONLY : GPD, GPD_SDP2       ,&
            ...
            &VFPGLOB, S2RVZ0HH2D, S2RVZ0HL2D, S2RVANMAXL2D, S2RVZ0MH2D, S2RVZ0ML2D
...
USE YOMSURF_SSDP_MOD , ONLY : SSDP2D_ID 
...
ALLOCATE (GPD_SDP2(NPOI,5))  ! TODO: Change 5 by a global param in ifsaux 
S2RVZ0HH2D   => GPD_SDP2(:,SSDP2D_ID%S2_RVZ0HH2D)
S2RVZ0HL2D   => GPD_SDP2(:,SSDP2D_ID%S2_RVZ0HL2D)
S2RVANMAXL2D => GPD_SDP2(:,SSDP2D_ID%S2_RVANMAXL2D) !derived SDP
S2RVZ0MH2D   => GPD_SDP2(:,SSDP2D_ID%S2_RVZ0MH2D)
S2RVZ0ML2D   => GPD_SDP2(:,SSDP2D_ID%S2_RVZ0ML2D)
