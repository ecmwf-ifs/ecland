...
USE YOMGPD1S , ONLY : GPD, GPD_SDP2, GPD_SDP3       ,&
            ...
            &S3RWRESTM3D, S3RWSATM3D, S3RVROOTSAH3D, S3RVROOTSAL3D, S3RCWPSISM3D, &
            &S3RDMAXM3D, S3RDMINM3D, S3RLAMBDADRYM3D, S3RLAMSAT1M3D, S3RMFACM3D, &
            &S3RQWEVAPM3D, S3RQWSBCRM3D, S3RRCSOILM3D, S3RWCAPM3D, S3RWPWPM3D
...
ALLOCATE (GPD_SDP2(NPOI,65))  ! TODO: Change 65 by a global param in ifsaux 
...
ALLOCATE (GPD_SDP3(NPOI,NCSS,20))  ! TODO: Change 20 by a global param in ifsaux 
...
S3RCWPSISM3D   => GPD_SDP3(:,:,SSDP3D_ID%NRCWPSISM3D)
...
S3RQWEVAPM3D   => GPD_SDP3(:,:,SSDP3D_ID%NRQWEVAPM3D)
S3RQWSBCRM3D   => GPD_SDP3(:,:,SSDP3D_ID%NRQWSBCRM3D)
