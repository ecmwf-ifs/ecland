...
DO JT=1,KSNTILES
  ...
  !! Preparation
      ZFRSN_TOT=MAX(PFRTI(KIDIA:KFDIA,5)+PFRTI(KIDIA:KFDIA,7),YDSOIL%RFRTINY)
      DO JK=1,KLEVSN
      ...
      ZSNQRAD=0._JPRB
        ...
        DO JK=1, KLACT
          ZDSN(JK)=MAX(0._JPRB, MIN(RDSNMAX,PSSNM1M(JL,JK)/(ZFRSN_TOT(JL)*PRSNM1M(JL,JK))))
