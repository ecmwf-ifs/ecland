...
REAL(KIND=JPRB)  :: ZLARGE,ZLARGESN,ZRTTMEPS,ZSNOW,ZSNOWHVEG,ZSTABEXSN,ZLARGEWT,ZSNOW_GLACIER,ZSNOW_SICE
...
! added fix to be consistent with Peters-Lidard et al. 1998 
    ...
    ZSNOWSK=MAX(0.19_JPRB,MIN(2._JPRB,FSOILTCOND(PWSAM1M(JL,1),RWSATM3D(JL,1),ZFF,MAX(1,KSOTY(JL)))))
    PLAMSK(JL,JT)=2._JPRB*ZSNOWSK*ZTMP1
  ENDDO
