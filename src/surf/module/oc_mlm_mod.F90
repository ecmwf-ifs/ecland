...
!
  LLINCR = .FALSE.
  CALL TRIDAG(AU(:,1:KLEVO),BU(:,1:KLEVO),CU(:,1:KLEVO),FU(:,1:KLEVO),U(:,1:KLEVO), &
  &           KLEVO,KIDIA,KFDIA,KLON,LLINCR)
  CALL TRIDAG(AU(:,1:KLEVO),BU(:,1:KLEVO),CU(:,1:KLEVO),FV(:,1:KLEVO),V(:,1:KLEVO), &
  &           KLEVO,KIDIA,KFDIA,KLON,LLINCR)
  CALL TRIDAG(AT(:,1:KLEVO),BT(:,1:KLEVO),CT(:,1:KLEVO),FT(:,1:KLEVO),T(:,1:KLEVO), &
  &           KLEVO,KIDIA,KFDIA,KLON,LLINCR)
  CALL TRIDAG(AE(:,1:KLEVO),BE(:,1:KLEVO),CE(:,1:KLEVO),FE(:,1:KLEVO),POTKE(:,1:KLEVO), &
  &           KLEVO,KIDIA,KFDIA,KLON,LLINCR)
