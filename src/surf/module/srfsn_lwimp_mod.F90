...
ASSOCIATE(RSNPER=>YDSOIL%RSNPER, RSNDTDESTROI=>YDSOIL%RSNDTDESTROI, &
 ...
 & LELWTL=>YDEXC%LELWTL, RVLAMSK_DESERT=>YDVEG%RVLAMSK_DESERT, RVLAMSK_SNOW=>YDVEG%RVLAMSK_SNOW)
...
! SOLVE IMPLICIT TEMPERATURE EQUATION
    ZTSTAR=(PTSNM1M(JL)+ZCONS2*(ZHFLUX+ZHFLUXRF1+ZTSURF*ZRS))/(1.0_JPRB+ZCONS2*ZRS)
...
! HEATING PART OF THE TIME STEP
      ZDTH=((ZT0-PTSNM1M(JL))*(ZCONSA+ZCONSB))/SIGN(MAX(ZEPSILON, &
       & ABS(ZHFLUX+ZHFLUXRF1-(ZT0-ZTSURF)*ZRS)), &
       & ZHFLUX+ZHFLUXRF1-(ZT0-ZTSURF)*ZRS )
