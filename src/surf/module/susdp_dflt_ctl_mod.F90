...
CONTAINS
SUBROUTINE SUSDP_DFLT_CTL(PTVL, PTVH, PSLT, KLEVS3D, PSSDP2, PSSDP3, YDVEG, YDSOIL)
...
ASSOCIATE(RVCOVH2D=>PSSDP2(:,SSDP2D_ID%NRVCOVH2D), RVCOVL2D=>PSSDP2(:,SSDP2D_ID%NRVCOVL2D), &
       ...
       &  RVRSMINB2D=>PSSDP2(:,SSDP2D_ID%NRVRSMINB2D), RMVGALPHA3D=>PSSDP3(:,:,SSDP3D_ID%NRMVGALPHA3D))
...
DO JL=1, KLEVS3D
  RMVGALPHA3D(:,JL)= YDSOIL%RMVGALPHA(PSLT(:))
ENDDO
