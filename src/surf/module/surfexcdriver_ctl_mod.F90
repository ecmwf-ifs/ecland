...
REAL(KIND=JPRB) :: ZBVOCDIAGVT(KLON,YDBVOC%NEMIS_BVOC,KTILES)
...
REAL(KIND=JPRD) :: PUMLEV_TOT,PVMLEV_TOT,PTMLEV_TOT,PQMLEV_TOT,PAPHMS_TOT,PGEOMLEV_TOT,&
   & PCPTGZLEV_TOT,PCPTSTI_TOT,ZQSATI_TOT,ZZ0MTI_TOT,ZZ0HTI_TOT,&
   & ZZ0QTI_TOT,ZZDLTI_TOT,ZBUOMTI_TOT, ZCFMTI_TOT,PCFHTI_TOT
...
!*         1.2  UPDATE Z0
CALL VUPDZ0(KIDIA,KFDIA,KLON,KTILES,KSTEP,CDCONF,LDSICE, LESNICE, &
