...
CONTAINS
  SUBROUTINE SUSSURF_PARAMS(TMP_SURF,YDSOIL,YDVEG,YDAGS,YDFLAKE,YDEXC)
...
YDFLAKE%RPHI_T_PR0_1           = TMP_SURF%RPHI_T_PR0_1
YDFLAKE%RPHI_T_PR0_2           = TMP_SURF%RPHI_T_PR0_2
YDFLAKE%RC_TT_1                = TMP_SURF%RC_TT_1
YDFLAKE%RC_TT_2                = TMP_SURF%RC_TT_2
...
YDFLAKE%RPHI_I_AST_MR          = TMP_SURF%RPHI_I_AST_MR
YDFLAKE%RC_I_MR                = TMP_SURF%RC_I_MR
