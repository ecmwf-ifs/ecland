...
REAL(KIND=JPRB) :: ZCOR5, ZF5, ZWROOTL5, ZWROOTH5, ZF2L5, ZF2H5, ZF2B5
REAL(KIND=JPRB) :: ZSRFL5, ZF1L5, ZQSAIR5, ZF3H5, ZF3L5, ZF1H5

REAL(KIND=JPRB) :: Z3S, Z4S, ZLIQP1, ZLIQP2, ZF2LP1, ZF2LP2
REAL(KIND=JPRB) :: ZF2HP1, ZF2HP2, ZF2BP1, ZF2BP2, ZF1LP
REAL(KIND=JPRB) :: Z5S, Z6S, ZWETL, ZWETH
REAL(KIND=JPRB) :: Z3S5, Z4S5, ZLIQP15, ZLIQP25, ZF2LP15, ZF2LP25
REAL(KIND=JPRB) :: ZF2HP15, ZF2HP25, ZF2BP15, ZF2BP25, ZF1LPI5, ZF1LP5
...
!   if first soil layer temperature is freezing then shutdown transpiration
      ...
      ZF2H5=RCEPSW
    ELSE
      ZF2LP1  =  ZQWEVAP*ZWROOTL
      ZF2LP15 = (ZWROOTL5-ZWPWP)*ZQWEVAP
      IF (ZF2LP15 < 1.0_JPRB) THEN
        ZF2LP2  = ZF2LP1
        ZF2LP25 = ZF2LP15
      ELSE
        ZF2LP2  = 0.0_JPRB
      ...
      ELSE
        ...
        ZF2L5 = RCEPSW
      ENDIF
      ZF2HP1  =  ZQWEVAP*ZWROOTH
      ZF2HP15 = (ZWROOTH5-ZWPWP)*ZQWEVAP
      IF (ZF2HP15 < 1.0_JPRB) THEN
        ZF2HP2  = ZF2HP1
        ZF2HP25 = ZF2HP15
      ELSE
        ZF2HP2  = 0.0_JPRB
    ...
    ZF2BP1  = ZLIQ(JL,1)*ZQWEVAP
    ZF2BP15 = (ZLIQ5(JL,1)-ZWPWP)*ZQWEVAP
    IF (ZF2BP15 < 1.0_JPRB) THEN
      ZF2BP2  = ZF2BP1
      ZF2BP25 = ZF2BP15
    ELSE
      ZF2BP2  = 0.0_JPRB
...
!           radiation stress function (proposed by Alan Betts): ZF1 
    ...
    ZSRFL5 = PSRFD5(JL)/250._JPRB
    ZF1LPI5 = 1.0_JPRB/(ZSRFL5+0.05_JPRB)
    ZF1LP  = 0.81_JPRB*ZF1LPI5*(1._JPRB-(1.+ZSRFL5)*ZF1LPI5)*ZSRFL
    ZF1LP5 = 0.81_JPRB*(1.+ZSRFL5)*ZF1LPI5
...
!           atmospheric moisture deficit stress function : F3
    ...
    PWETB (JL) = -ZRSMINB*ZF2BI5*ZF2BI5*ZF2B
    PWETB5(JL) = ZRSMINB*ZF2BI5
  ENDDO
ENDIF
