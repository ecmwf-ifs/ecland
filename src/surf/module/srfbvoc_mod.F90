...
DO JVT=1,KTILES
 ...
 WRITE(*,*)'DEBUG BVOC 1 Type',JVT,':',SUM(PBVOCDIAGVT(KIDIA:KFDIA,1,JVT))/(KFDIA-KIDIA+1)
 WRITE(*,*)'DEBUG BVOC 2 Type',JVT,':',SUM(PBVOCDIAGVT(KIDIA:KFDIA,2,JVT))/(KFDIA-KIDIA+1)
