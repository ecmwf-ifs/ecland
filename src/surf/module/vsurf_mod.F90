...
IF ( LEMIS_BVOC ) THEN   
  ...
  !VH IF (KTILE==4 .OR. KTILE==6 .OR. KTILE==7 ) THEN
    ...
    IF (KTILE==3) THEN 
      ...
      WRITE(*,*)'DEBUG W1:',MINVAL(IVEG_BVOC(KIDIA:KFDIA)),MAXVAL(IVEG_BVOC(KIDIA:KFDIA))
      WRITE(*,*)'DEBUG W2:',MINVAL(PLAI_WET(KIDIA:KFDIA)),MAXVAL(PLAI_WET(KIDIA:KFDIA))
      WRITE(*,*)'DEBUG W3:',MINVAL(PLAIP_WET(KIDIA:KFDIA)),MAXVAL(PLAIP_WET(KIDIA:KFDIA))
    ELSE
